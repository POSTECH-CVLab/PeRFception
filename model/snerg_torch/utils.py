...
def render_rays(
    ...
    rgb_map, disp_map, acc_map, weights, depth_map, alpha_c = raw2outputs(
    ...
    if num_fine_samples > 0:
        ...
        rgb_map, disp_map, acc_map, weights, depth_map, alpha = raw2outputs(
            raw, z_vals, rays_d, raw_noise_std, white_bkgd
        )

    ret = {
        "rgb_map": rgb_map, "disp_map": disp_map, "acc_map": acc_map, 
        "depth_map": depth_map, "alpha_c": alpha_c
    }
    if retraw:
        ret["raw"] = raw
    if num_fine_samples > 0:
